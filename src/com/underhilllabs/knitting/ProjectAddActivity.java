	        ...
	        add_button.setOnClickListener(new Button.OnClickListener() {
	            public void onClick(View v) {
	                ...
	                String status = spinner_status.getSelectedItem().toString();
	 				...
	 				String needed_shopping= shopping_field.getEditableText().toString();;
	                //get date string
	                DateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
	                java.util.Date date = new java.util.Date();
	                String cdatetime = dateFormat.format(date);
	                //ProjectAddActivity.this.timeStampFormat.Format(new Date());
	                pdb.createProject(name, cdatetime, cdatetime,status,status_i, notes,needed_shopping);
	 				Intent i = new Intent(ProjectAddActivity.this,KnittingStashHome.class);
	 				i.putExtra("com.underhilllabs.knitting.tabid",2);
	 				startActivity(i);
	                //Toast.makeText(KnittingInventory.this, "Added to Project Inventory", Toast.LENGTH_SHORT).show();
