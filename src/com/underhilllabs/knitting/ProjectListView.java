...
public class ProjectListView extends ListActivity {
	...
	public void fill_data() {
    	...
    	startManagingCursor(cur);
       	String[] displayFields = new String[] { DbAdapter.KEY_NAME,DbAdapter.KEY_NEEDED_SHOPPING, DbAdapter.KEY_NOTES};
       	int[] displayViews = new int[] { R.id.name_row,R.id.shopping_row,R.id.notes_row};
       	...
       	projects.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
			...
			public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
				int nCheckedIndex = cursor.getColumnIndexOrThrow(DbAdapter.KEY_NEEDED_SHOPPING);
    ...
    public boolean deleteProject(long nid) {
    	...
    	AlertDialog.Builder builder = new AlertDialog.Builder(ProjectListView.this);
        builder.setTitle(R.string.delete_dialog_title_project)
        	...
        	.setPositiveButton(R.string.dialog_button_delete, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent i2 = new Intent(ProjectListView.this,KnittingStashHome.class);
