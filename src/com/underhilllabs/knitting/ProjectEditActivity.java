		...
		if (requestCode == TAKE_PICTURE) {
			if (data != null && data.hasExtra("data")) {
				...
				try {
					...
					// http://docs.google.com/Doc?docid=0AX7RnSwRegJfYWg3eG5za2t4bnFmXzEyNGZkdDV0d2R6&hl=en
					File imgDir = new File(Environment
							.getExternalStorageDirectory(), "/knittingstash/");
