...
public class CounterListView extends ListActivity {
	...
	public void fill_data() {
		...
		// Toast.makeText(CounterListView.this, "current val"+cur.getShort(2),
		// Toast.LENGTH_SHORT);
		startManagingCursor(cur);
		String[] displayFields = new String[] { DbAdapter.KEY_NAME,
				DbAdapter.KEY_NOTES };
		int[] displayViews = new int[] { R.id.name_row, R.id.notes_row };
		setListAdapter(new SimpleCursorAdapter(this, R.layout.counter_list_row,
	...
	public boolean deleteCounter(long nid) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(
				CounterListView.this);
		builder.setTitle(R.string.delete_dialog_title_counter).setMessage(
				R.string.delete_dialog_text_counter).setPositiveButton(
				...
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						// HookListView.class);
						Intent i2 = new Intent(CounterListView.this,
