...
/** Called when the activity is first created. */
	...
	private OnClickListener radio_listener = new OnClickListener() {
		public void onClick(View v) {
        	...
        	//Toast.makeText(HookEditActivity.this, "rowid is "+rowid, Toast.LENGTH_SHORT).show();
    	}
 	};
 	...
 	public void onCreate(Bundle savedInstanceState) {
        ...
        rowid = extras.getLong("com.underhilllabs.knitting.rowid"); 
 		...
 		ArrayAdapter<CharSequence> adapter_size = ArrayAdapter.createFromResource(
            this, R.array.hook_array, android.R.layout.simple_spinner_item);
 		...
 		add_button.setOnClickListener(new Button.OnClickListener() {
            ...
            Intent i = new Intent(HookEditActivity.this,KnittingStashHome.class);
            i.putExtra("com.underhilllabs.knitting.tabid",1);
            startActivity(i);
            //Toast.makeText(HookEditActivity.this, "Added to Hook Inventory", Toast.LENGTH_SHORT).show();
