	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        add_button.setOnClickListener(new Button.OnClickListener() {
	            public void onClick(View v) {
	                ...
	                ndb.createNeedle(size,size_i, type, material, length,length_i, is_metric, is_crochet, notes, in_use);
	                Intent i = new Intent(NeedleAddActivity.this,KnittingStashHome.class);
