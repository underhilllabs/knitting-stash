...
public class HookListView extends ListActivity {
	...
	public void fill_data(String sort_key) {
		...
		String[] displayf = new String[] { DbAdapter.KEY_SIZE,
				DbAdapter.KEY_NOTES, DbAdapter.KEY_MATERIAL };
		int[] displayv = new int[] { R.id.size_row, R.id.notes_row,
				R.id.material_row };
		// setListAdapter(new SimpleCursorAdapter());
		setListAdapter(new SimpleCursorAdapter(this, R.layout.hook_list_row,
				cur, displayf, displayv));
	...
	public boolean deleteNeedle(long nid) {
		...
		builder.setTitle(R.string.delete_dialog_title_hook).setMessage(
				R.string.delete_dialog_text_hook).setPositiveButton(
				...
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						// HookListView.class);
						Intent i2 = new Intent(HookListView.this,
