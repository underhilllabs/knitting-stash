	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        add_button.setOnClickListener(new Button.OnClickListener() {
	            public void onClick(View v) {
	                ...
	                int multiple = 1;
	                //get date string
	                //ateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
	                //java.util.Date date = new java.util.Date();
	                //String cdatetime = dateFormat.format(date);
	                //ProjectAddActivity.this.timeStampFormat.Format(new Date());
	                pdb.createCounter(name,cur_val,proj_id,proj_name,up_or_down,type,multiple, notes);
					Intent i = new Intent(CounterAddActivity.this,KnittingStashHome.class);
